      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-[64px] border-b border-white/5 bg-[#08090A]/80 backdrop-blur-xl">
        <div className="max-w-[1200px] mx-auto h-full px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-[13px] font-medium text-[#8A8F98]">
             <a href="#" className="hover:text-[#F7F8F8] transition-colors">Imkoniyatlar</a>
             <a href="#" className="hover:text-[#F7F8F8] transition-colors">Talabalar uchun</a>
             <a href="#" className="hover:text-[#F7F8F8] transition-colors">Tariflar</a>
             <a href="#" className="hover:text-[#F7F8F8] transition-colors">Yordam</a>
          </nav>
